...
public class MainClass {
    ...
    public static void main(String[] args) {
        ...
        //Обращение к классу, где выполняется первичная проверка правильности введенного выражения
        CheckInPut check = new CheckInPut(action, inPutWithoutSpace);
    ...
    public static class CheckInPut {
        public CheckInPut (char action, String inPutWithoutSpace) {

            switch (action) {
                case '+':
                case '-':
                    checkPlusAndMinus((inPutWithoutSpace));

                    break;
                case '*':
                case '/':
                    checkMultAndDivision((inPutWithoutSpace));
                    break;
            }
        }
